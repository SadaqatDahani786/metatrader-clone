...
const defaultState = [
  {
    ...
    address: {
      ...
      city: "Karachi",
      zipcode: "",
      address: "21st jump street, avenue park",
    },
    deposit: {
      amount: "40,000.00",
      currency: "USD",
...
const sliceAccounts = createSlice({
  ...
  reducers: {
    addAccount: (state, { payload }) => {
      //1) Make active account false
      const updatedState = state.map((acc) =>
        acc.isActiveAccount === true ? { ...acc, isActiveAccount: false } : acc
      );
...
export const { addAccount } = sliceAccounts.actions;
